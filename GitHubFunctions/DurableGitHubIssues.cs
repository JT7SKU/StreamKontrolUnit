...
{
    public static class DurableGitHubIssues
    {
        ...
        private static GitHubClient github = new GitHubClient(new ProductHeaderValue("GitHubFunctions")) { Credentials = new Credentials(getToken()) };
        ...
        [FunctionName("DurableGitHubIssues")]
            ...
            [OrchestrationTrigger] DurableOrchestrationContext context)
        {
            ...
            var repositories = await context.CallActivityAsync<List<(long id, string name)>>("DurableGitHubIssues_GetAllRepositoriesForOrganization", organizationName);
        ...
        [FunctionName("Durable_GetAllRepositoriesForOrganization")]
        ...
        /// <summary>
        /// Trigger FUnction start Durable orchestration function
        /// </summary>
        /// <param name="req"></param>
        /// <param name="starter"></param>
        /// <param name="log"></param>
        /// <returns></returns>
        [FunctionName("DurableGitHubIssues_HttpStart")]
            ...
            ILogger log)
        {
            ...
            string instanceId = await starter.StartNewAsync("DurableGitHubIssues", "Nuget");
