...
using WeatherDiary.Helpers;
using WeatherDiary.Services;
...
namespace WeatherDiary.Views
{
    public sealed partial class WeatherMapPage : Page, INotifyPropertyChanged
    {
